    ...
    for y in range(starty):
        ...
        for x in range(startx):
            ...
            if themap.mapArr[y][x] == 2:
                line.append("#")
            if themap.mapArr[y][x] == 3 or themap.mapArr[
                    y][x] == 4 or themap.mapArr[y][x] == 5:
                line.append("=")
...
def getEntrance():
    ...
    m.append(
        "OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO")
    m.append(
        " OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO   OO       OO    OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO ")
    m.append(
        "   OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO   OO  OOO  OOOO  OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO   ")
    m.append(
        "     OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO   OO       OO    OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO     ")
    m.append(
        "       OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO   OO  OOO  OOOO  OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO       ")
    m.append(
        "         OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO   OO       OO    OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO         ")
    m.append(
    ...
    m.append(
        "                                        OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO                                          ")
    m.append(
        "                                        OOOOOOOOOOOOOOOOOOOOOOOOOOOOO the fortress of dorf OOOOOOOOOOOOOOOOOOOOOOOOOOOO                                          ")
    m.append(
        "                                        OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO                                          ")
    m.append(
        "                                                            OOOOOOOOOOOOOOOOO[___]OOOOOOOOOOOOOOOOO                                                              ")
    m.append(
        "                                                            OOOOOOOOOOOOOOOOO#___#OOOOOOOOOOOOOOOOO                                                              ")
    m.append(
        "                                                            OOOOOOOOOOOOOOOOO#___#OOOOOOOOOOOOOOOOO                                                              ")
